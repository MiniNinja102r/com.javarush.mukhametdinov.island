...
//            IslandConfig.Island.X_SIZE = Configs.getInteger(config, "x_size", 1);
//            IslandConfig.Island.Y_SIZE = Configs.getInteger(config, "y_size", 1);
//            IslandConfig.Island.MAX_LOCATIONS_ON_ISLAND = IslandConfig.Island.X_SIZE * IslandConfig.Island.Y_SIZE;
        }
    }
